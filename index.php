...
<?php 
echo do_shortcode('[smartslider3 slider=1]'); /** Головний слайдер **/
?>
...
<div class="container-fluid" id="content">
	<div class="row mt-4">
			...
			<div class="row">
				...
				<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
					...
					<div class="d-flex align-items-stretch col-xs-12 col-sm-12 col-md-12 col-lg-4 mt-4 mb-3">
						...
						<div class="post post-hover"> <!--Початок посту -->
							...
							<a href="<?php the_permalink(); ?>">
								...
								<?php } else { ?>
									<div class="pinImage" style="height: auto;">
										<img class="wp-post-image" 
										src="<?php echo get_stylesheet_directory_uri().'/img/thumbnail_placeholder_720.jpg'; ?>" style="height: 100%; width: 100%;">
									</div>
								<?php } ?>
							</a>
				...
				<p><?php esc_html_e( 'Записи не знайдені. Спробуйте, будь ласка, пізніше. РСС НТУ.' ); ?></p>

				<?php endif; ?>	<!-- Кінець циклу -->

			</div>
			<!-- останні новини кінець-->
										...
										<div class="row ml-auto" style="width: 27%; background-color: #ff6262; position: absolute; height: 100%; right: 0; top: 0;">
											<div class="text-center my-auto mx-auto">
												<p class="" style="color: #fff; font-size: 3rem; position: relative; top: 5px; margin-bottom: 0; padding-bottom: 0;">
													<?php echo tribe_get_start_date( $post->ID, true, 'd' ) . ' '; ?>
												</p>
		...
		<div class="col d-xl-block d-lg-none d-sm-none d-xs-none d-md-none">
			...
			<div class="cf1 container-fluid" style="padding-right: .9%">
				...
				<div class="row mb-3">
					...
					<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
						...
						<div class="d-flex align-items-stretch col-xs-12 col-sm-12 col-md-12 col-lg-4 mt-4 mb-3">
							...
							<div class="post" style="border-radius: 1%; overflow: hidden; background-color: #f7f7f7"> <!-- Початок запису -->
								<a style="color: #fff;" href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">
									<h3 class="prewText" style="position: absolute; top: 5%; background-color: #ff62628a; padding: 3% 10% 3% 3%; margin-right: 3%;">
					...
					<?php endwhile; else : ?> <!-- Кінець циклу -->
